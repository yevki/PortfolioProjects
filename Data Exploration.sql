...
Skills used: Joins, CTE's, Temp Tables, Windows Functions, Procedures, Functions, Aggregate Functions, Creating Views, Converting Data Types
...
-- Establish a procedure that displays the total number of infections against the total number of deaths in the country
